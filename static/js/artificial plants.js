...
const products = [
  {
    ...
    imageUrl: "static/images/artificial plants/rose.jpg",
  ...
  },
  {
    ...
    imageUrl: "static/images/artificial plants/snake.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 500
  },
  {
    ...
    imageUrl: "static/images/artificial plants/peace lily.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 1000
  },
  {
    ...
    imageUrl: "static/images/artificial plants/dracaena.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 700
  },
  {
    ...
    imageUrl: "static/images/artificial plants/bamboo.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 600
  },
  {
    ...
    imageUrl: "static/images/artificial plants/fern.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 400
  },
  {
    ...
    imageUrl: "static/images/artificial plants/english_ivy.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 900
  },
  {
    ...
    imageUrl: "static/images/artificial plants/spider.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 550
  }
];
...
// Function to populate artificial plant products on the page
function populateArtificialPlantProducts(productsToDisplay = products) {
      ...
      <div class="product-box">
        ...
        <div class="quantity-selector">
          <select id="quantity-select" data-product-id="${product.id}">
            ${product.quantityOptions.map((option) => `<option value="${option}">${option} pcs</option>`).join("")}
          </select>
        </div>
...
// Populate initial artificial plant products on page load
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (searchedProduct) {
    ...
    populateArtificialPlantProducts(filteredProducts);
  } else {
    populateArtificialPlantProducts();
  }
});
...
document.getElementById('search-box').addEventListener('input', function() {
  ...
  if (searchTerm) {
    ...
    populateArtificialPlantProducts(filteredProducts);  // Update the displayed products based on search
  } else {
    populateArtificialPlantProducts();  // Show all products if no search term
  }
});
