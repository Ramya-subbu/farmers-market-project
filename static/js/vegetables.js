...
const products = [
  {
    id: 1,
    name: "Carrot",
    imageUrl: "static/images/vegetables/carrot.jpg",
  ...
  },
  {
    id: 2,
    name: "Potato",
    imageUrl: "static/images/vegetables/potato.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 40
  },
  {
    id: 3,
    name: "Broccoli",
    imageUrl: "static/images/vegetables/broccoli.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 30
  },
  {
    id: 4,
    name: "Onion",
    imageUrl: "static/images/vegetables/onion.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 50
  },
  {
    id: 5,
    name: "Cucumber",
    imageUrl: "static/images/vegetables/cucumber.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 45
  },
  {
    id: 6,
    name: "Spinach",
    imageUrl: "static/images/vegetables/spinach.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 30
  },
  {
    id: 7,
    name: "Cauliflower",
    imageUrl: "static/images/vegetables/cauliflower.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 80
  },
  {
    id: 8,
    name: "Kale",
    imageUrl: "static/images/vegetables/kale.jpg",
    quantityOptions: [1, 2, 3, 4, 5],
    price: 60
  }
];
...
function populateVegetablesProducts(productsToDisplay = products) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (searchedProduct) {
    ...
    populateVegetablesProducts(filteredProducts);
  } else {
...
document.getElementById('search-box').addEventListener('input', function() {
  ...
  if (searchTerm) {
    ...
    populateVegetablesProducts(filteredProducts);  // Update the displayed products based on search
  } else {
    populateVegetablesProducts();  // Show all products if no search term
  }
});
